...
{
    return [NSDictionary dictionaryWithObjectsAndKeys:m_identifier, KEY_IDENTIFIER, m_name, KEY_NAME, m_currency, KEY_CURRENCY, [NSNumber numberWithInteger:m_price], KEY_PRICE, nil];
}
...
{
    return ([m_identifier isEqualToString:delivery.identifier] && [m_name isEqualToString:delivery.name] && [m_currency isEqualToString:delivery.currency] && m_price == delivery.price) ? YES : NO;
}
